...
from agent_executor import WikipediaAgentExecutor
...
def main():
    """Entry point for Wikipedia Agent."""
    host = "localhost"
    port = 10001
    try:
        ...
        skill = AgentSkill(
            id="wikipedia_checker",
            name="Wikipedia Checker",
            description="Check wikipedia for a given topic",
            tags=["schedule", "availability", "calendar"],
            examples=[
                "Search Wikipedia for Gautama Buddha",
                "Can you check Wikipedia for the Swaraj?",
            ],
        )
        ...
        agent_card = AgentCard(
            ...
            description="A friendly agent to help you check Wikipedia for topics.",
            url=agent_host_url,
            version="1.0.0",
