...
class ContextAgentExecutor(AgentExecutor):
    """AgentExecutor for the ContextAgent in 'The Poet and the Sage'."""

    def __init__(self, runner: Runner, agent_name: str = "context_agent"):
        self.runner = runner
    ...
    async def _process_request(
        ...
        async for event in self._run_agent(session_id, new_message):
            if event.is_final_response():
                ...
                logger.debug("Final poetic context: %s", parts)
